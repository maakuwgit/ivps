		...
		<asp:Repeater runat="server" ID="Tabs">
			<ItemTemplate>
				...
				<div style="margin: .5rem 0 0 0;">
					<asp:label runat="server" CssClass="input-label" Text='<%#Eval("Name") %>' ></asp:label>
				</div>
				<br>
				<div><label>Tab Content</label></div>
				<div style="margin: .5rem 0 1.5rem 0;">
				<asp:HiddenField runat="server" Value='<%# Eval("Id") %>' ID="txtId"></asp:HiddenField> 
				<asp:textbox runat="server" CssClass="ckeditor" Text='<%#Eval("Content") %>' MaxLength="2048" TextMode="MultiLine" Rows="10" style="min-width:400px; width:500px; max-width:700px; max-height:500px;" ClientIDMode="Static"></asp:textbox>
				</div>
