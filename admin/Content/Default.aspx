...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
    ...
    <asp:button ID="btnAdd" ToolTip="Add a New Testimonial" runat="server" Text="Add Content" class="btn btn-primary btn-sm my-3"/><br />
    ...
    <asp:GridView ID="gvContent" runat="server" AutoGenerateColumns="False" GridLines="None" CssClass="table table-hover searchableTable" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" EmptyDataText="No content areas have been created yet.">
            <Columns>
        <asp:BoundField DataField="Id" HeaderText="Id" />
        <asp:BoundField DataField="Page" HeaderText="Page" />
        <asp:BoundField DataField="Name" HeaderText="Name" />
        <asp:BoundField DataField="DateModified" HeaderText="Last Modified" DataFormatString="{0:d}" />
        <asp:TemplateField HeaderText="Actions">
            <ItemTemplate>
                <div class="btn-group">
                	...
                	<asp:Button ID="btnDuplicate" runat="server" Text="Duplicate" CommandArgument='<%#Eval("Id") %>' OnClientClick="return confirm('Are you sure?')" OnClick="btnDuplicate_Click" class="btn btn-outline-info btn-sm"/>
                </div>
            </ItemTemplate>
        </asp:TemplateField>
        </Columns>
