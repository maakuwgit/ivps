...
Partial Class admin_Content_Default
    ...
    Protected Sub LoadGrid()
        Dim dt As DataTable = RC4.Pull("Select * from WMASiteErrorLog Where response_status_code = 404 Order By LastUpdate Desc")
    ...
    Protected Sub btnDelete_Click(ByVal s As Button, ByVal e As EventArgs)
        ...
        RC4.SQLExec("Delete from WMASiteErrorLog where Id=" & id)
        Response.Redirect("/Admin/404Log/")
    End Sub
