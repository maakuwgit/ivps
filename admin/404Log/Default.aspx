...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
    <h1>Website 404 Log</h1>
    <asp:button ID="btnAdd" runat="server" Text="Add New Redirect" class="btn btn-primary btn-sm my-3 d-none"/>
    ...
    <asp:GridView ID="gvContent" runat="server" AutoGenerateColumns="False" GridLines="None" CssClass="table table-hover searchableTable" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" EmptyDataText="No links have been added.">
        ...
        <asp:TemplateField HeaderText="Actions">
            <ItemTemplate>
                <div class="btn-group">
                <asp:Button ID="btnEdit" runat="server" Text="Redirect" CommandArgument='<%#Eval("Id") %>' OnClick="btnEdit_Click" class="btn btn-outline-primary btn-sm "/>
