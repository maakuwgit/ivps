...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
    ...
    <asp:button ID="btnAdd" ToolTip="" runat="server" Text="Add Product" class="btn btn-primary btn-sm my-3"/>
    <asp:button ID="btnCat" ToolTip="" runat="server" Text="Categories" class="btn btn-outline-primary btn-sm my-3"/><br />
    ...
    <asp:GridView ID="gvContent" runat="server" AutoGenerateColumns="False" GridLines="None" CssClass="table table-hover searchableTable" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" EmptyDataText="No Product has been created yet.">
            <Columns>
