<%@ Page Title="" Language="VB" MasterPageFile="~/admin/Admin.master" AutoEventWireup="false" CodeFile="Add.aspx.vb" Inherits="AddProduct" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
  <input type="button" value="< Back" onclick="window.history.go(-1)" class="btn btn-secondary btn-sm my-3"/>
    ...
    <div class="alert alert-info alert-dismissible fade show" role="alert" style="display:<%# iif(LCase(GetUserLoggedIn(Session("user")).email) = "rcc@romeocomp.com", "block", "none") %>">
    	<asp:Label CssClass="input-label" runat="server" ID="lblSnippet" class="d-none"></asp:Label>
	</div>
	
	<div class="form-group">
	<asp:CheckBox id="cbFeatured" Text="&nbsp;Featured" runat="server" name="Featured" ></asp:CheckBox>
     </div>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        <label class="input-label" for="ctl00_main_txtName">Price</label>
        <asp:TextBox runat="server" ID="price" class="form-control col-12 col-lg-4" type="number" min="0.00" max="10000.00" step="0.01" ></asp:TextBox>
    </div>
    
    <div class="form-group">
        <label class="input-label" for="ctl00_main_txtContent">Content</label>
        <textarea runat="server" id="txtContent" class="form-control"><div class="container"><div class="row"><div class="col-12"></div></div></div></textarea>
    </div>
	...
	<div class="pb-5">
	<asp:Image id="productimg" runat="server" height="200" />
     </div>
