...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
    ...
    <input type="button" value="Links" id="btnNews" />
    <p class="tip">To reorder categories, click the drag handle and move them up or down.</p>
    <asp:GridView ID="gvCats" runat="server" AutoGenerateColumns="False" GridLines="None" RowStyle-CssClass="" CssClass="mGrid" PagerStyle-CssClass="pgr" EmptyDataText="No categories have been created yet.">
        <Columns>
