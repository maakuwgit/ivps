...
Public Class NewsController
    ...
    Public Function Cornerstones() As DataTable
    	return RC4.Pull("Select * from RCNews Where Cornerstone = 1 Order By seq, id")
    End Function
    
   Public Function CategoryArticles() As DataTable
    	return RC4.Pull("Select Top " & Me.SelectTopNumber & " * from RCNews Where PubDate <= '" & Today.Date.ToShortDateString & "' And CatId = " & Me.CategoryId & " order by PubDate desc") 
    End Function
